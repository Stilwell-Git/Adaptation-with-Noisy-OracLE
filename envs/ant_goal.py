...
https://github.com/katerakelly/oyster/blob/master/rlkit/envs/ant_goal.py
"""
...
class AntGoalEnv(MultitaskAntEnv):
    ...
    def oracle_reward_func(self, infos):
        goal_reward = -np.sum(np.abs(infos['xposafter'] - self._goal))
        return goal_reward - infos['ctrl_cost'] - infos['contact_cost'] + infos['survive_reward']
